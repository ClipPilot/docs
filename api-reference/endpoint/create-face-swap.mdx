...
Submit a video and a face image to generate an AI face swap. You can provide **public URLs**, **upload files directly**, or a **mix of both**.
...
<ParamField body="video_url" type="string">
  A publicly accessible URL to the source video. Required if not uploading a `video` file.
</ParamField>
