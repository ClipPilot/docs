...
curl -X POST https://api.cuttr.com/api/platform/v1/clip \
  ...
  -d '{
    ...
    "auto_heading": true,
    "heading": { "style": "instagram", "color": "yellow", "font": "Luckiest Guy" },
...
<ParamField body="camera_mode" type="string" default="standard">
  ...
  - `gaming` — detects facecam overlay and separates gameplay + facecam
...
<ParamField body="camera_mode" type="string" default="standard">
  How the video is framed. One of `standard`, `gaming`, `speaker-zoom`, `center-crop`, `active-speaker`.
</ParamField>
