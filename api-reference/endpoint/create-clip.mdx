...
curl -X POST https://api.cuttr.com/api/platform/v1/clip \
  ...
  -d '{
    ...
    "auto_heading": true,
    "heading": { "style": "instagram", "bg_color": "black", "font": "Anton" },
...
<ParamField body="heading" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="heading.style" type="string" default="stroke">
      Heading style. `stroke` = outlined text, `instagram` = white text on dark background.
    </ParamField>
    <ParamField body="heading.color" type="string" default="white">
      Text color. One of `white`, `black`, `red`, `orange`, `yellow`, `green`, `teal`, `blue`, `purple`, `pink`. Only applies to `stroke` style.
    </ParamField>
    <ParamField body="heading.font" type="string" default="Montserrat">
      Heading font. One of `Montserrat`, `Luckiest Guy`, `Everlasting`, `Komika`, `Burbank`, `Bebas Neue`, `Anton`.
    </ParamField>
    ...
    <ParamField body="heading.bg_color" type="string" default="black">
      Background color for the `instagram` style. One of `black`, `white`. Text color auto-adjusts (black bg = white text, white bg = black text). Only applies to `instagram` style.
    </ParamField>
    <ParamField body="heading.instructions" type="string">
      Optional instructions to guide AI heading generation (e.g. "focus on product benefits", "use question-style headings"). Only applies when `auto_heading` is true and no custom `text` is provided. Max 500 characters.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="captions" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="captions.font" type="string" default="Montserrat">
      Caption font. One of `Montserrat`, `Luckiest Guy`, `Everlasting`, `Komika`, `Burbank`, `Bebas Neue`, `Anton`.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="heading_style" type="string" default="stroke">
  `stroke` (outlined) or `instagram` (white text on dark background).
</ParamField>

<ParamField body="heading_color" type="string" default="white">
  Heading text color. One of `white`, `black`, `red`, `orange`, `yellow`, `green`, `teal`, `blue`, `purple`, `pink`.
</ParamField>
...
<ParamField body="heading_bg_color" type="string" default="black">
  Background color for `instagram` style. One of `black`, `white`. Text color auto-adjusts.
</ParamField>

<ParamField body="heading_instructions" type="string">
  Instructions to guide AI heading generation. Max 500 characters.
</ParamField>
